...
- [Design](#design)
  - [Colours and Backgrounds](#colours-and-backgrounds)
...
- [Features](#features)
  ...
  - [Checkout Page and Success Checkout Page](#checkout-page-and-success-checkout-page)
...
To make it as easy as possible purchase a product via this site using a secure payment system like stripe.  
...
**Project Objectives:** Was to see if it created interest in the product and test for educational purposes if this is possible for me to create a online e-commerce that is functional. I also tried to educate clients on the benefits of shaving with de razors and single-edge razors in a minimalistic way. 
