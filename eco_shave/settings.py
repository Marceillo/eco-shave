"""
Django settings for eco_shave project.
...
SECRET_KEY = 'django-insecure-9_nwhy!%+@jzs!)cm2mv*0kwknk-^+_#q8lpx82i2h!cw5(yu0'
...
MEDIA_URL = '/shave_media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'shave_media')
